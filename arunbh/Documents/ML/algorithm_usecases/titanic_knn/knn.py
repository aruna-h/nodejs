# -*- coding: utf-8 -*-
"""
Created on Tue Feb 26 18:23:50 2019
...
for depth in depth_range:
     ...
     scores = cross_val_score(knn, totaldata.drop(["Survived"], axis=1).values, totaldata[["Survived"]].values, cv=3 , scoring='accuracy')
...
from sklearn.metrics import confusion_matrix
predictions = cross_val_predict(knn, x_trainsplit, y_trainsplit)
...
predictions = cross_val_predict(knn,x_testsplit,y_testsplit)
