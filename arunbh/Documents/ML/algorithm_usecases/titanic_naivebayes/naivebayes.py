# -*- coding: utf-8 -*-
"""
Created on Tue Feb 26 18:30:58 2019
...
for depth in depth_range:
     gaussian = GaussianNB() 
     scores = cross_val_score(gaussian, totaldata.drop(["Survived"], axis=1).values, totaldata[["Survived"]].values, cv=3 , scoring='accuracy')
...
predictions = cross_val_predict(gaussian, x_trainsplit, y_trainsplit)
...
predictions = cross_val_predict(gaussian,x_testsplit,y_testsplit)
